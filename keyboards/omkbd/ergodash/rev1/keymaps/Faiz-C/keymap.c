...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT(
    KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_NPAD,                         KC_NPAD, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_DEL,
    ...
    KC_LCTL, XXXXXXX, KC_LGUI, KC_LCTL,          KC_LALT, KC_SPC, KC_LOWR,        KC_QSYM, KC_BSPC, KC_ENT,           KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
  ),
  ...
  [_QUICK_SYMBOLS] = LAYOUT(
    ...
    _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    _______,                         _______, KC_GRV,  KC_MINS, KC_EQL,  KC_AMPR, KC_AT,   _______,
    _______, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    _______,                         _______, KC_LBRC, KC_LPRN, KC_DLR,  KC_EXLM, _______, _______,
    _______, _______, _______, _______, _______, _______, _______,                         _______, KC_RBRC, KC_RPRN, KC_CIRC, KC_HASH, _______, KC_PERC,
