...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT(
    ...
    KC_CESC, KC_A,    KC_S,    KC_D, KC_F,   KC_G,     KC_LBRC,                        KC_RBRC, KC_H,    KC_J,  KC_K,    KC_L,    KC_SCLN, KC_QUOT,
    KC_LSFT, KC_Z,    KC_X,    KC_C, KC_V,   KC_B,     KC_LPRN,                        KC_RPRN, KC_N,    KC_M,  KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
    KC_LCTL, KC_LGUI, KC_LALT, EISU,         KC_LOWR,  KC_SPC, KC_BSPC,       KC_BSPC, KC_ENT,  KC_RASE,        KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
  ),
   ...
   */
  [_LOWER] = LAYOUT(
    _______, _______, _______, _______, _______, _______, _______,                        _______, _______, _______, KC_NUM,  KC_PSLS, KC_PAST, KC_PMNS,
    _______, _______, _______, _______, _______, _______, _______,                        _______, _______, _______, KC_KP_7, KC_KP_8, KC_KP_9, KC_PPLS,
    _______, _______, _______, _______, _______, _______, _______,                        _______, _______, _______, KC_KP_4, KC_KP_5, KC_KP_6, KC_PPLS,
    _______, _______, _______, _______, _______, _______, _______,                        _______, _______, _______, KC_KP_1, KC_KP_2, KC_KP_3, KC_PENT,
    QK_BOOT, _______, _______, _______,          KC_LOWR, KC_SPC, _______,       KC_BSPC, KC_ENT,  _______,          KC_KP_0, KC_KP_0, KC_PDOT, KC_PENT
  ),
